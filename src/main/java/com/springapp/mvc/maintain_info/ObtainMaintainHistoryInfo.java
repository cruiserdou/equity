...
@Controller
@RequestMapping("/obtain_maintain_history_info")
public class ObtainMaintainHistoryInfo {
    ...
    DataShop getShopInJSON(
        ...
        try{
            ...
            if (mi_corp_id != null)
                sql += " and maintain_info.mi_corp_id =" + mi_corp_id;

            sql += " order by  maintain_info.mi_id desc ";
