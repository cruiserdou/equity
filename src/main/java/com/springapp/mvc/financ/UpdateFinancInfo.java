...
@Controller
@RequestMapping("/update_financ_info")
public class UpdateFinancInfo {
    ...
    DataShop getShopInJSON(
        ...
        try {
            ...
            String sql = "UPDATE work.tb_financ\n" +
                    "   SET famount=?, fmode=?, fuse=?, ftermdt=?, fcosts=?, payment_pl=?, \n" +
                    "       payment_gt=?, supply_sd=?, supply_md=?, costs=? " +
                    " where id = ?";
