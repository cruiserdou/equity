...
@Controller
@RequestMapping("/export_enterprise_xls")
public class ExportXlsEnterprise {
    ...
    DataShop getShopInJSON(
        ...
        String xlsFile="/static/upload/"+fileName;
        ...
        try{
            ...
            String sql = "select RANK() OVER(ORDER BY id) as 序号,buslicno as 营业执照号码,name as 企业名称,unit as 单位类别,legrep as  法定代表人," +
                    " nos as 公司简称,nature as 企业性质,regdt as 注册日期,bustremtdt as 营业期限至,bustermfdt as 营业期限自,regaddr as 注册地址 " +
            ...
            HSSFSheet sheet=workbook.createSheet("企业名册");
...
//            font0.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
            ...
            ce.setCellValue(new HSSFRichTextString("企业名册"));
