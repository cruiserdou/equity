...
//                    "       remark=?, gr_contact=?, gr_psotion=?, gr_edoctype=?, gr_edocnum=?, \n" +
//                    "       gr_ephone=?, gr_efax=?, gr_eemail=?, gr_eqq=?, gr_webchat=?, \n" +
//                    "       gr_tel=?, gr_bz=?, indclass1=?, indclass2=?, indclass3=?, indclass4=?, \n" +
//                    "       csrc_type1=?, csrc_type2=?, csrc_type3=?, csrc_type4=?, changer_id=?, \n" +
//                    "       changer_dt=?, changer_dept=?, recomdt=?, trusteeship=?, listst=?, \n" +
//                    "       eclass=?, maintain=?, reserve=?, emaint=?, dept=?, post=?, tel=?, \n" +
//                    "       phone=?, fax=?, email=?, qq=?, webchat_wh=?, bz_wh=?, type_enterp=?, \n" +
//                    "       type_server=?, type_investors=?, type_govermt=?, demand_rz=?, \n" +
//                    "       demand_px=?, demand_rl=?, inputdt=?, start_time=?, end_time=?, \n" +
//                    "       st_money_fund=?, end_money_fund=?, st_jyxjr_assets=?, end_jyxjr_assets=?, \n" +
//                    "       st_ys_bill=?, end_ys_bill=?, st_ys_account=?, end_ys_account=?, \n" +
//                    "       st_yf_money=?, end_yf_money=?, st_ys_interest=?, end_ys_interest=?, \n" +
...
//                    "       end_hj_fz_owner_right=?, server_name=?, server_type=?, server_content=?, \n" +
//                    "       server_levels=?, server_domain=?, server_penalty=?, server_examiner=?, \n" +
//                    "       server_post=?, server_descs=?, server_remark=?, inv_domain=?, \n" +
//                    "       inv_csrc_type1=?, inv_csrc_type2=?, inv_csrc_type3=?, inv_csrc_type4=?, \n" +
//                    "       inv_indclass1=?, inv_indclass2=?, inv_indclass3=?, inv_indclass4=?, \n" +
//                    "       inv_contact=?, inv_psotion=?, inv_doctype=?, inv_docnum=?, inv_phone=?, \n" +
//                    "       inv_fax=?, inv_email=?, inv_qq=?, inv_webchat=?, inv_tel=?, inv_remark=?, \n" +
//                    "       gov_domain=?, gov_office=?, gov_desc=?, gov_contact=?, gov_psotion=?, \n" +
//                    "       gov_doctype=?, gov_docnum=?, gov_phone=?, gov_fax=?, gov_email=?, \n" +
//                    "       gov_qq=?, gov_webchat=?, gov_tel=?, gov_remark=?, rz_amounts=?, \n" +
//                    "       rz_use=?, rz_financ=?, rz_security=?, rz_acc_cost=?, rz_deadline=?, \n" +
//                    "       rz_desc=?, px_mode=?, px_content=?, px_acc_cost=?, px_dt=?, px_requests=?, \n" +
//                    "       hr_post=?, hr_num=?, hr_salary=?, hr_sex_req=?, hr_age_req=?, \n" +
//                    "       hr_requests=? " +
//                    " WHERE id=? ";
