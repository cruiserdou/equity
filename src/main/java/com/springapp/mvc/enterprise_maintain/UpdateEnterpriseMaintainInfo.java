...
@Controller
@RequestMapping("/update_enterprise_maintain_info")
public class UpdateEnterpriseMaintainInfo {
    ...
    DataShop getShopInJSON(
        ...
        try {
            ...
            if (!file.isEmpty()) {
                ...
                String sql = "select phone_file from work.tb_enterprise_maintain  where id = "+id;
            ...
            String sql_insert = "UPDATE work.tb_enterprise_maintain\n" +
                    "   SET   enterprise_id=?, receive_per=?, maintain_date=?, important_level=?, \n" +
                    "       content=?, result=?, next_plan=?, next_date=?, next_content=?, \n" +
                    "       phone_file=?, remark=?" +
                    " where id = ?";
