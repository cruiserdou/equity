...
Ext.define('App.view.enterprise.Applyf', {
    ...
    applyTpl: [
        ...
        '<th>行业一级分类</th>',
        '<td>    ' +
        '<select class="select" style="width: 200px" name="indclass1" id="cl1">',
        '<option>-一级-</option>',
        ' </select>',
        '</td>',
        '<th>行业二级分类</th>',
        '<td>',
        '<select class="select" style="width: 200px"  name="indclass2" id="cl2">',
        '<option>-2级-</option>',
        ' </select>',
        '</td>',
        '</tr>',
        ...
        '<th>行业三级分类</th>',
        '<td>',
        '<select class="select" style="width: 200px"  name="indclass3" id="cl3">',
        '<option>-3级-</option>',
        ' </select>',
        '</td>',
        '<th>行业四级分类</th>',
        '<td>',
        '<select class="select" style="width: 200px"  name="indclass4" id="cl4">',
        '<option>-4级-</option>',
        ' </select>',
        '</td>',
        '</tr>',
