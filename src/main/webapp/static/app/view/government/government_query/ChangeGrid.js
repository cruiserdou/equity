...
Ext.define('App.view.government.government_query.ChangeGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.government_query_change_grid',
    columnLines: true,
    enableLocking: true,
    animCollapse: true,
    store: 'corp_government_change',
    selModel: new Ext.selection.CheckboxModel({checkOnly: false}),
    id: 'grid_government_query_change',
