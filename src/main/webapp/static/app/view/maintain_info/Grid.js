...
Ext.define('App.view.maintain_info.Grid', {
    ...
    initComponent: function () {
        ...
        this.columns = [
            ...
            {text: '挂牌代码', width: 220, dataIndex: 'mi_listcode'},
            {text: '省',  width: 220, dataIndex: 'mi_province'},
            {text: '市', width: 220, dataIndex: 'mi_city'},
            {text: '县',  width: 220, dataIndex: 'mi_county'},
            {text: '维护时间',  width: 220, dataIndex: 'mi_mt_date'},
            {text: '企业客户分级(A/B）', width: 220, dataIndex: 'mi_cust_type'},
            {text: '下次维护时间', width: 220, dataIndex: 'mi_next_date'},
