Ext.define('App.view.refi.refi_rop.Query', {
    extend: 'Ext.form.Panel',
    alias: 'widget.refi_ropf_query',
    split: true,
    height: 100,
    bodyPadding: 20,
    frame: false,
    ...
    dockedItems: [
        {
            ...
            items: [
                                                    ...
                                                    if (form.isValid()){
                                                        form.submit({
                                                            ...
                                                            success: function(form, action){
                                                                ...
                                                                //重新载入渠道信息
                                                                Ext.getCmp('grid_refi_rop').getStore().reload();
                                                            },
                ...
                },'-',
                {
                    ...
                    id: 'refi_rop_edit',
                    handler: function(){
                        var sm = Ext.getCmp('grid_refi_rop').getSelectionModel();
                        ...
                        editWindow.show(Ext.get('refi_rop_edit'));
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: function(){
                            var store = Ext.getCmp('grid_refi_rop').getStore();
                            store.load({
                                params: {
