...
Ext.define('App.view.refinancing.refinancing_query.ChangeGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.refinancing_query_change_grid',
    columnLines: true,
    enableLocking: true,
    animCollapse: true,
    store: 'corp_refinancing_change',
    selModel: new Ext.selection.CheckboxModel({checkOnly: false}),
    id: 'grid_refinancing_query_change',
