...
Ext.define('App.view.investors.investors_query.ChangeGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.investors_query_change_grid',
    columnLines: true,
    enableLocking: true,
    animCollapse: true,
    store: 'corp_investors_change',
    selModel: new Ext.selection.CheckboxModel({checkOnly: false}),
    id: 'grid_investors_query_change',
