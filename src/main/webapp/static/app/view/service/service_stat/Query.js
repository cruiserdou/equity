            ...
            items: [
                {
                    allowBlank: true,
                    fieldLabel: '营业执照号码',
                    id: 'query_service_stat_buslicno',
                    emptyText: '营业执照号码'
                },
                {
                    allowBlank: true,
                    fieldLabel: '挂牌代码',
                    id: 'query_service_stat_listcode',
                    emptyText: '挂牌代码'
                }
                        ...
                        click: function () {
                            ...
                            store.load({
                                params: {
                                    ...
                                    nos: Ext.getCmp('query_service_stat_nos').getValue(),
                                    buslicno: Ext.getCmp('query_service_stat_buslicno').getValue(),
                                    listcode: Ext.getCmp('query_service_stat_listcode').getValue()
