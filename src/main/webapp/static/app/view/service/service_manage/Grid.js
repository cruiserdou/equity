    ...
    listeners: {
        'itemdblclick': function (view, record, item, index, e) {
            ...
            var apply_edits = new Ext.XTemplate(
                ...
                '<a href="#"  style="font-size:18px;text-decoration: none;text-align: center;color: #ffffff;  margin: 1em auto;width: 8em;border-radius: 5px;  padding: 0.5em 0;background-color: #38AD5A; border: 1px solid #38AD5A;display: block;  "  onclick="save_service_edit({id})">保存</a>' +
...
function save_service_edit(id) {
    //Ext.Msg.alert("提示", id);
    var form_obt_apply = document.getElementById("service_form");
    Ext.Ajax.request({
        method: "POST",
        params: {
            serviceid: form_obt_apply['serviceid'].value,
